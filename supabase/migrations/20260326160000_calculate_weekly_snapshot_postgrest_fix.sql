-- Corrección PostgREST: la RPC debe coincidir con la firma que expone Supabase (orden típico alfabético de argumentos).
-- Si ya ejecutaste 20260326143000 con la firma antigua (p_year antes que p_week_number), este script reemplaza la función.
